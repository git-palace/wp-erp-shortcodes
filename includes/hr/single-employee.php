        ...
        <div class="erp-area-left full-width erp-hr-employees-wrap-inner">
            <div id="erp-area-left-inner">
                ...
                if ( current_user_can( 'administrator' ) ) {
                    $tabs = array_merge( $tabs, array( 'permission' => array(
                        'title'    => __( 'Permission', 'erp' ),
                        'callback' => 'erp_hr_employee_single_tab_permission'
                    ) ) );
                }

                $tabs       = apply_filters( 'erp_hr_employee_single_tabs', $tabs, $employee );
                ...
                <h2 class="nav-tab-wrapper erp-hide-print" style="margin-bottom: 15px;">
                    <?php foreach ($tabs as $key => $tab) {
                        ...
                        ?>
                        <a href="<?php echo add_query_arg( array( 'id' => $employee->get_user_id(), 'tab' => $key ), home_url( '/myteam/single-teammate') ); ?>" class="nav-tab<?php echo $active_class; ?>"><?php echo $tab['title'] ?></a>
                    <?php } ?>
                </h2>
